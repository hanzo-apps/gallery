...
export function Footer() {
  return (
    <footer className="py-16 px-4 bg-[#0a0a0a] border-t border-neutral-800">
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-5 gap-12 mb-12">
          ...
          <div className="md:col-span-2">
            ...
            <p className="text-neutral-500 text-sm leading-relaxed max-w-xs">
              Premium UI/UX templates for modern web applications. Built with Next.js, React, and TypeScript.
            </p>
          </div>
        ...
        {/* Bottom bar */}
        <div className="flex flex-col md:flex-row items-center justify-between pt-8 border-t border-neutral-800 gap-4">
          <p className="text-neutral-600 text-sm">
            © 2016-2026 Hanzo AI Inc. All rights reserved.
          </p>
